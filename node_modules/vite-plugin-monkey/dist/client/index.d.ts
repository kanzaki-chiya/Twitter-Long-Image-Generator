...
interface GmAudioType {
    ...
    addStateChangeListener(listener: GmAudioStateChangeListener, callback: GmVoidCallback): void;
    removeStateChangeListener(listener: GmAnyFuntion, callback: GmVoidCallback): void;
}
